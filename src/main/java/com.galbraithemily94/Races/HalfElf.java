...
public class HalfElf extends Race {
    ...
    public String getEarlyLife(Character character) {
        ...
        String halfElf1 = " Half elves live between two worlds. Welcome by humans, but outliving them. Less welcomed by " +
                "elves, and often feeling restless in their timeless societies.";
        String halfElf2 = " Half elves tend to be driven by wanderlust because of their long lives and lack of a true home or people.";
        String halfElf3 = " Half elves inherit their ambition, curiosity, and inventiveness from humans and love of " +
                "nature and whimsy from elves.";
        earlyLives.add("amongst humans in a bustling city. Often seeking out quiet dilapidated areas where wild plants " +
                "fought to take root." + halfElf3 + " While happy amongst humans, sometimes the lack of nature felt suffocating");
        earlyLives.add("amongst elves always feeling a bit out of step with " + character.getPossessivePronoun().toLowerCase() +
                " peers." + halfElf1 + " Sneaking off to a nearby city was life altering, the energy of human life was " +
